...
export default function AgraPage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival in Agra", desc: "Check-in at hotel, visit Agra Fort, evening stroll near Mehtab Bagh." },
    { day: "Day 2", title: "Taj Mahal & Departure", desc: "Sunrise visit to Taj Mahal, explore local markets, and departure." },
  ];
  ...
  const highlights = [
    ...
    "Agra Fort",
    "Mehtab Bagh",
    "Local Mughlai Cuisine Experience",
  ];

  const photos = ["/tour7a.jpg", "/tour7b.jpg", "/tour7c.jpg"];

  return (
    <div className="min-h-screen bg-slate-50">
      {/* Hero Section */}
      <div className="relative h-80 w-full">
        <Image src="/tour7a.jpg" alt="Agra" fill className="object-cover" />
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white text-center">
          <h1 className="text-4xl font-bold">Agra Heritage & Taj Mahal Tour</h1>
          <p className="mt-2 text-lg">2 Days / 1 Night</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            District: Agra, Uttar Pradesh. <br />
            Explore the iconic Taj Mahal, historical Agra Fort, and enjoy authentic Mughlai cuisine.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20an%20Agra%20tour.%20Please%20connect%20with%20me"
            target="_blank"
