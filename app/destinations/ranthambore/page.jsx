...
export default function RanthamborePage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival at Ranthambore", desc: "Check-in at the resort, evening leisure or local village exploration." },
    { day: "Day 2", title: "Tiger Safari & Wildlife Exploration", desc: "Morning and evening jeep safari in Ranthambore National Park, spot tigers and other wildlife." },
    { day: "Day 3", title: "Ranthambore Fort & Departure", desc: "Visit the historic Ranthambore Fort, check-out, and depart." },
  ];
  ...
  const photos = ["/tour18a.jpg", "/tour18b.jpg", "/tour18c.jpg"];

  return (
    <div className="min-h-screen bg-slate-50">
      <div className="relative h-80 w-full">
        <Image src="/ranthambore.jpg" alt="Ranthambore" fill className="object-cover" />
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white text-center">
          <h1 className="text-4xl font-bold">Ranthambore Tiger Safari</h1>
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            District: Sawai Madhopur, Rajasthan. <br />
            Experience thrilling wildlife safaris and witness majestic tigers in their natural habitat.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20a%20Ranthambore%20tour.%20Please%20connect%20with%20me"
            target="_blank"
