...
export default function VaishnoDeviPage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival & Check-in", desc: "Reach Katra, check-in at hotel, evening local sightseeing." },
    { day: "Day 2", title: "Vaishno Devi Darshan", desc: "Helicopter ride option or trek to Bhawan, Ardh Kuwari Cave visit." },
    { day: "Day 3", title: "Return Journey", desc: "Scenic trek back, checkout, and depart." },
  ];

  const highlights = [
    "Helicopter Ride Option to Vaishno Devi",
    "Bhawan Darshan",
    "Ardh Kuwari Cave",
    "Scenic Trek through Trikuta Hills"
  ];

  const photos = ["/tour26a.jpg", "/tour26b.jpg", "/tour26c.jpg"];

  return (
    <div className="min-h-screen bg-slate-50">
      <div className="relative h-80 w-full">
        <Image src="/vaishnodevi.jpg" alt="Vaishno Devi" fill className="object-cover" />
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white text-center">
          <h1 className="text-4xl font-bold">Vaishno Devi Spiritual Yatra</h1>
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            District: Reasi, Jammu & Kashmir. <br />
            Experience the spiritual journey to the holy Vaishno Devi shrine, including trekking through Trikuta Hills.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20a%20Vaishno%20Devi%20tour.%20Please%20connect%20with%20me"
            target="_blank"
