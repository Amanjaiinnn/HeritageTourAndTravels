...
export default function KathmanduPage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival in Kathmandu", desc: "Check-in, explore Thamel area and local markets." },
    { day: "Day 2", title: "Temple Visits", desc: "Visit Pashupatinath Temple, Boudhanath Stupa, and nearby heritage sites." },
    { day: "Day 3", title: "Durbar Squares", desc: "Explore Kathmandu & Patan Durbar Squares, local cultural experiences." },
    { day: "Day 4", title: "Swayambhunath & Surroundings", desc: "Visit Swayambhunath (Monkey Temple), garden walks, cultural immersion." },
    { day: "Day 5", title: "Departure", desc: "Morning free time, checkout and depart." },
  ];
  ...
  const photos = ["/tour23a.jpg", "/tour23b.jpg", "/tour23c.jpg"];
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            Location: Kathmandu, Nepal (No Passport required for Indians). <br />
            Explore the rich cultural heritage, ancient temples, stupas, and vibrant local markets of the Kathmandu Valley.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20a%20Kathmandu%20tour.%20Please%20connect%20with%20me"
            target="_blank"
