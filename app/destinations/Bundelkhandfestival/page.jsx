...
export default function DestinationPageD() {
  const itinerary = [
    { day: "Day 1", title: "Chitrakoot", desc: "Khamariya-Madfa Fort, Panchmukhi Mahadev Temple. Ranipur Tiger Sanctuary (Mangawa side). Night Stay: Khamariya Homestay." },
    { day: "Day 2", title: "Mahoba", desc: "Srinagar-Raja Mohan Singh Fort, Kajli Mela grounds (seasonal). Charkhari 108 Temples, Royal Cenotaphs. Night Stay: Srinagar Homestay." },
    { day: "Day 3", title: "Mahoba", desc: "Kakun or revisit Charkhari surroundings. Evening in Charkhari lakeside. Night Stay: Srinagar or Mirtala Homestay." },
    { day: "Day 4", title: "Departure", desc: "" },
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="relative h-80 w-full">
        ...
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white text-center">
          <h1 className="text-4xl font-bold">Royal Bundelkhand & Festival Tour  </h1>
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
           Discover the heart of Bundelkhand's royal past on a journey blending fortresses and faith.
            This trip highlights the majestic forts of Madfa and Mahoba alongside the spiritual wonder of Charkhari's 108 temples,
             a true mix of history and devotion.
           <br /> Districts: Chitrakoot, Mahoba.
          </p>
