...
export default function CorbettPage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival & Check-in", desc: "Reach Corbett, check-in, evening nature walk." },
    { day: "Day 2", title: "Jeep Safari & Temple Visit", desc: "Jeep safari in Corbett Tiger Reserve, visit Garjia Devi Temple and Corbett Waterfall." },
    { day: "Day 3", title: "Departure", desc: "Birdwatching trails, morning checkout, and depart." },
  ];
  ...
  const photos = ["/tour27a.jpg", "/tour27b.jpg", "/tour27c.jpg"];

  return (
    <div className="min-h-screen bg-slate-50">
      <div className="relative h-80 w-full">
        <Image src="/tour27a.jpg" alt="Corbett" fill className="object-cover" />
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white text-center">
          <h1 className="text-4xl font-bold">Corbett National Park Safari</h1>
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            ...
            Explore the lush landscapes of Corbett Tiger Reserve with wildlife safaris, temples, waterfalls, and birdwatching trails.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20a%20Corbett%20tour.%20Please%20connect%20with%20me"
            target="_blank"
