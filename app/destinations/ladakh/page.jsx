...
export default function LadakhPage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival in Leh", desc: "Check-in and acclimatization, explore Leh local market." },
    { day: "Day 2", title: "Leh Sightseeing", desc: "Visit Shanti Stupa, Leh Palace, and local monasteries." },
    { day: "Day 3", title: "Pangong Lake Excursion", desc: "Drive to Pangong Lake, enjoy scenic views and photography." },
    { day: "Day 4", title: "Nubra Valley", desc: "Drive via Khardung La Pass, explore Diskit Monastery and camel safari." },
    { day: "Day 5", title: "Monastery Tour", desc: "Visit Hemis and Thiksey Monasteries, return to Leh." },
    { day: "Day 6", title: "Leisure & Local Exploration", desc: "Free day to relax or explore Leh on your own." },
    { day: "Day 7", title: "Departure", desc: "Check-out and transfer to airport for onward journey." },
  ];
  ...
  const photos = ["/tour13a.jpg", "/tour13b.jpg", "/tour13c.jpg"];
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            District: Leh, Jammu & Kashmir. <br />
            Experience breathtaking landscapes, high mountain passes, pristine lakes, and Tibetan Buddhist culture.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20a%20Leh-Ladakh%20tour.%20Please%20connect%20with%20me"
            target="_blank"
