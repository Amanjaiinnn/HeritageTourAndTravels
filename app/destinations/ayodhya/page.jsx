...
export default function AyodhyaPage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival in Ayodhya", desc: "Check-in, evening visit to Ram Mandir surroundings and local market stroll." },
    { day: "Day 2", title: "Ayodhya Temples Tour", desc: "Visit Ram Mandir, Hanuman Garhi, Kanak Bhawan, and local ghats." },
    { day: "Day 3", title: "Varanasi Excursion", desc: "Drive to Varanasi, visit Dashashwamedh Ghat, evening Ganga Aarti." },
    { day: "Day 4", title: "Saryu Aarti & Local Sightseeing", desc: "Attend Saryu Aarti, explore local markets, prepare for departure." },
    { day: "Day 5", title: "Departure", desc: "Checkout and depart with spiritual memories." },
  ];
  ...
  const photos = ["/tour20a.jpg", "/tour20b.jpg", "/tour20c.jpg"];
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            Districts: Varanasi & Ayodhya, Uttar Pradesh. <br />
            Experience the spiritual aura of Ayodhya and Varanasi, visiting temples, ghats, and attending holy aartis.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20an%20Ayodhya%20tour.%20Please%20connect%20with%20me"
            target="_blank"
