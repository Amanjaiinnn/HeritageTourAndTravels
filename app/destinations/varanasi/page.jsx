...
export default function VaranasiPage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival in Varanasi", desc: "Check-in, evening Ganga Aarti at Dashashwamedh Ghat." },
    { day: "Day 2", title: "Spiritual Varanasi", desc: "Visit Kashi Vishwanath Temple, boat ride on River Ganga, explore ghats." },
    { day: "Day 3", title: "Excursion to Sarnath & Departure", desc: "Explore Sarnath Buddhist site, local sightseeing, departure." },
  ];
  ...
  const photos = ["/tour6a.jpg", "/tour6b.jpg", "/tour6c.jpg"];

  return (
    <div className="min-h-screen bg-slate-50">
      {/* Hero Section */}
      <div className="relative h-80 w-full">
        <Image src="/varanasi.jpg" alt="Varanasi" fill className="object-cover" />
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white text-center">
          <h1 className="text-4xl font-bold">Spiritual Varanasi & Ganga Aarti</h1>
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            District: Varanasi, Uttar Pradesh. <br />
            One of the world’s oldest living cities, known for its ghats, temples, and spiritual significance.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20a%20Varanasi%20tour.%20Please%20connect%20with%20me"
            target="_blank"
