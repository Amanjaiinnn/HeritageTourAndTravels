...
export default function BodhGayaPage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival in Bodh Gaya", desc: "Check-in and visit Mahabodhi Temple for evening meditation." },
    { day: "Day 2", title: "Buddhist Circuit Tour", desc: "Visit Great Buddha Statue, Bodhi Tree, and Dungeshwari Caves." },
    { day: "Day 3", title: "Departure", desc: "Morning checkout and depart to next destination." },
  ];
  ...
  const photos = ["/tour30a.jpg", "/tour30b.jpg", "/tour30c.jpg"];
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            ...
            Explore the sacred sites of Buddhism, meditate under the Bodhi Tree, and visit the Dungeshwari Caves and Great Buddha Statue.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20a%20Bodh%20Gaya%20tour.%20Please%20connect%20with%20me"
            target="_blank"
