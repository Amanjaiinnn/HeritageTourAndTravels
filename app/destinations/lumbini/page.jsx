...
export default function LumbiniPage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival in Lumbini", desc: "Check-in, evening visit to local monasteries." },
    { day: "Day 2", title: "Sacred Sites", desc: "Visit Maya Devi Temple, Ashokan Pillar, and explore Sacred Garden." },
    { day: "Day 3", title: "Monastic Zone", desc: "Explore Lumbini Monastic Zone, meditation, and cultural immersion." },
    { day: "Day 4", title: "Departure", desc: "Morning meditation, checkout and depart." },
  ];
  ...
  const highlights = [
    ...
    "Ashokan Pillar",
    "Sacred Garden & Bodhi Tree"
  ];

  const photos = ["/tour24a.jpg", "/tour24b.jpg", "/tour24c.jpg"];

  return (
    <div className="min-h-screen bg-slate-50">
      <div className="relative h-80 w-full">
        <Image src="/tour24a.jpg" alt="Lumbini" fill className="object-cover" />
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white text-center">
          <h1 className="text-4xl font-bold">Lumbini Buddhist Circuit Tour</h1>
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            Location: Lumbini, Nepal (Birthplace of Lord Buddha). <br />
            Explore the sacred Buddhist sites, meditation centers, and tranquil monastic zones for spiritual immersion.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20a%20Lumbini%20tour.%20Please%20connect%20with%20me"
            target="_blank"
