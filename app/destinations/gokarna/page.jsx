...
export default function GokarnaPage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival in Gokarna", desc: "Check-in, evening walk on Om Beach, sunset views." },
    { day: "Day 2", title: "Beach Hopping & Temple Visit", desc: "Visit Kudle Beach, Paradise Beach trek, and Mahabaleshwar Temple." },
    { day: "Day 3", title: "Leisure & Water Activities", desc: "Relax at beaches, optional water sports, explore local village." },
    { day: "Day 4", title: "Departure", desc: "Morning checkout and depart." },
  ];
  ...
  const photos = ["/tour29a.jpg", "/tour29b.jpg", "/tour29c.jpg"];

  return (
    <div className="min-h-screen bg-slate-50">
      <div className="relative h-80 w-full">
        <Image src="/tour29a.jpg" alt="Gokarna" fill className="object-cover" />
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white text-center">
          <h1 className="text-4xl font-bold">Gokarna Beach & Temple Tour</h1>
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            District: Uttara Kannada, Karnataka. <br />
            A spiritual and beach retreat combining serene beaches with sacred temples and picturesque landscapes.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20a%20Gokarna%20tour.%20Please%20connect%20with%20me"
            target="_blank"
