...
export default function MountAbuPage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival in Mount Abu", desc: "Check-in, evening stroll near Nakki Lake and Sunset Point." },
    { day: "Day 2", title: "Dilwara Temples & Local Sightseeing", desc: "Visit Dilwara Jain Temples, Guru Shikhar, and local attractions." },
    { day: "Day 3", title: "Relaxation & Departure", desc: "Boat ride at Nakki Lake, local market exploration, checkout." },
  ];
  ...
  const photos = ["/tour21a.jpg", "/tour21b.jpg", "/tour21c.jpg"];

  return (
    <div className="min-h-screen bg-slate-50">
      <div className="relative h-80 w-full">
        <Image src="/mountabu.jpg" alt="Mount Abu" fill className="object-cover" />
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white text-center">
          <h1 className="text-4xl font-bold">Mount Abu & Dilwara Temples Tour</h1>
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            District: Sirohi, Rajasthan. <br />
            Explore Mount Abu, Rajasthan’s only hill station, known for serene lakes, temples, and breathtaking sunsets.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20a%20Mount%20Abu%20tour.%20Please%20connect%20with%20me"
            target="_blank"
