...
export default function NainitalPage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival in Nainital", desc: "Check-in, stroll along Mall Road, enjoy local cuisine." },
    { day: "Day 2", title: "Naini Lake & Tiffin Top", desc: "Boat ride on Naini Lake, trek to Tiffin Top, scenic photography." },
    { day: "Day 3", title: "Snow View & Zoo", desc: "Visit Snow View Point, Nainital Zoo, relax at local cafes." },
    { day: "Day 4", title: "Departure", desc: "Morning sightseeing, shopping, and departure." },
  ];
  ...
  const photos = ["/tour11a.jpg", "/tour11b.jpg", "/tour11c.jpg"];

  return (
    <div className="min-h-screen bg-slate-50">
      <div className="relative h-80 w-full">
        <Image src="/nainital.jpg" alt="Nainital" fill className="object-cover" />
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white text-center">
          <h1 className="text-4xl font-bold">Nainital Lake & Kumaon Hills Tour</h1>
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            District: Nainital, Uttarakhand. <br />
            Explore serene lakes, hills, trekking spots, and local culture in the Kumaon region.
          </p>
        </div>
        {/* Photo Carousel */}
        <div className="mb-10">
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20a%20Nainital%20tour.%20Please%20connect%20with%20me"
            target="_blank"
