...
export default function JaipurPage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival in Jaipur", desc: "Check-in at the hotel, evening stroll around local markets." },
    { day: "Day 2", title: "City Palace & Amber Fort", desc: "Visit Amber Fort with optional elephant ride, City Palace, and Hawa Mahal." },
    { day: "Day 3", title: "Cultural Exploration & Departure", desc: "Explore local Rajasthani cuisine, markets, and depart." },
  ];
  ...
  const photos = ["/tour19a.jpg", "/tour19b.jpg", "/tour19c.jpg"];

  return (
    <div className="min-h-screen bg-slate-50">
      <div className="relative h-80 w-full">
        <Image src="/tour19a.jpg" alt="Jaipur" fill className="object-cover" />
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white text-center">
          <h1 className="text-4xl font-bold">Jaipur Pink City Heritage Tour</h1>
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            District: Jaipur, Rajasthan. <br />
            Explore the historic Pink City with its grand palaces, forts, and vibrant Rajasthani culture.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20a%20Jaipur%20tour.%20Please%20connect%20with%20me"
            target="_blank"
