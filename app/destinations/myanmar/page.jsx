...
export default function MyanmarPage() {
  const itinerary = [
    { day: "Day 1", title: "Arrival in Tamu", desc: "Check-in, evening stroll around local market and river views." },
    { day: "Day 2", title: "Monastery Visits", desc: "Explore Tamu Monastery and nearby Kalay Buddhist monasteries." },
    { day: "Day 3", title: "River & Culture", desc: "Enjoy Chindwin River views, experience local Burmese cuisine." },
    { day: "Day 4", title: "Departure", desc: "Morning free time, checkout and depart." },
  ];

  const highlights = [
    "Tamu Local Market",
    "Kalay Buddhist Monasteries",
    "Chindwin River Views",
    "Burmese Cuisine Experience"
  ];

  const photos = ["/tour25a.jpg", "/tour25b.jpg", "/tour25c.jpg"];

  return (
    <div className="min-h-screen bg-slate-50">
      <div className="relative h-80 w-full">
        <Image src="/myanmar.jpg" alt="Myanmar" fill className="object-cover" />
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white text-center">
          <h1 className="text-4xl font-bold">Tamu Monastery & Kalay, Myanmar Tour</h1>
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-slate-700 leading-relaxed">
            Location: Tamu & Kalay, Myanmar (Accessible for Indians without Passport via Manipur). <br />
            Discover Burmese culture, Buddhist monasteries, river views, and authentic local cuisine.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="https://wa.me/919214152266?text=Namaste,%20I%20would%20like%20to%20customize%20a%20Myanmar%20tour.%20Please%20connect%20with%20me"
            target="_blank"
