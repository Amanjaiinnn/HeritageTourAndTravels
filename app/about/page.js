export default function AboutPage() {
  return (
    <div className="container max-w-6xl py-10 md:py-16">
      <h1 className="custom-heading ">About Us</h1>
      <p className="mb-8">
      ...
      <div className="mb-8">
        <h3 className="mt-6 mb-2"><strong>Tailored Tour Packages</strong></h3>
        <p>
      ...
      <div className="mb-8">
        <h3 className="mt-6 mb-2"><strong>Vehicle Rental Services</strong></h3>
        <p>
